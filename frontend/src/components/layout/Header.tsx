      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* Navigation links - only show after mount for authenticated users */}
            {mounted && user && (
              <nav className="flex items-center space-x-4">
                ...
                <a
                  href="/chat"
                  className="flex items-center space-x-1.5 text-sm font-medium text-gray-700 hover:text-primary-600 transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
